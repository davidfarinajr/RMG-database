...
entry(
    ...
    reference = Article(
        authors = [b'D. Polino', b'S.J. Klippenstein', b'L.B. Harding', b'Y. Georgievskii'],
        title = b'Predictive Theory for the Addition and Insertion of Kinetics of CH2 Reacting with Unsaturated Hydrocarbons',
        journal = b'JPCA',
        volume = b'117',
        pages = b'12677-12692',
        year = b'2013',
